...
class TodoListRpgApplicationTests {
	...
	void dailyQuestRoutine(){
		...
		DailyQuest quest = new DailyQuest("correr", "ficar rapido", 100, 3, QuestAttributes.STRENGTH);
	...
	void questRewardTest(){
		...
		Quest quest = new Quest("correr", "ficar rapido",130 , 3, QuestAttributes.STRENGTH);
